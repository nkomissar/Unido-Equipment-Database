...
call add_child_topic(@last_id, 'Производство тепла', 'Передача тепла');
call add_child_topic(@last_id, 'Выработка электроэнергии', 'Выработка электроэнергии');
call add_child_topic(@last_id, 'Производство тепла и холода', 'Производство тепла и холода');
call add_child_topic(@last_id, 'Производственные процессы', 'Производственные процессы');
