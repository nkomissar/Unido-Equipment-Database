...
CREATE  TABLE IF NOT EXISTS `eetdb`.`UNIDO_ENTITY_TEMPLATE` (
  ...
  `TEMPLATE_NAME`      NVARCHAR(45)  NULL ,
  `VERSION`            INT           NOT NULL DEFAULT '0',
  `UPDATED_BY`         NVARCHAR(100) NOT NULL ,
  `UPDATE_DATE`        TIMESTAMP     NOT NULL ,
...
CREATE  TABLE IF NOT EXISTS `eetdb`.`UNIDO_ENTITY_PROPERTY` (
  ...
  INDEX `fk_UNIDO_PROPERTY_UNIDO_VALUE_TYPE1` (`VALUE_TYPE_ID` ASC) ,
  ...
  CONSTRAINT `fk_UNIDO_ENTITY_PROPERTY_UNIDO_ENTITY_TEMPLATE_PROPERTY1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_UNIDO_PROPERTY_UNIDO_VALUE_TYPE1`
...
INSERT INTO `eetdb`.`SEQUENCE` VALUES (0); 
