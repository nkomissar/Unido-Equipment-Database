...
CREATE  TABLE IF NOT EXISTS `eetdb`.`UNIDO_ENTITY_PROPERTY` (
  ...
  INDEX `fk_UNIDO_ENTITY_PARAMETER_UNIDO_ENTITY` (`ENTITY_ID` ASC) ,
  INDEX `fk_UNIDO_ENTITY_PROPERTY_UNIDO_ENTITY_TEMPLATE_PROPERTY` (`TEMPLATE_PROPERTY_ID` ASC) ,
  CONSTRAINT `fk_UNIDO_ENTITY_PARAMETER_UNIDO_ENTITY`
    FOREIGN KEY (`ENTITY_ID` )
    REFERENCES `eetdb`.`UNIDO_ENTITY` (`ENTITY_ID` )
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_UNIDO_ENTITY_PROPERTY_UNIDO_ENTITY_TEMPLATE_PROPERTY`
...
INSERT INTO `eetdb`.`SEQUENCE` VALUES (100); 
